...
const namePoke = document.querySelector('#btn-poke');
const pokePropio = document.querySelector('#tipoPropio');
const pokeAtaque = document.querySelector('#ataquePropio');
const Ataque = document.querySelector('#combate');
...
const obtenerPokePropio = ()=>{
    ...
    axios.get(`https://pokeapi.co/api/v2/pokemon/${numPokeRival}`).then((res)=>{
        ...
        console.log(res);
        imgPoke.src = res.sprites.front_default;
...
btnPeler.addEventListener('click', combate);